...
GET DATA  /TYPE=TXT
  /FILE="/Volumes/CRCDE$/CURRENT STUDIES AND PAPERS/NSF EDL1 Gesture and Math Talk/Results:Figures/SPSS/export_childwords.tsv"
  /DELCASE=LINE
  /DELIMITERS="\t"
...
GET DATA  /TYPE=TXT
  /FILE="/Volumes/CRCDE$/CURRENT STUDIES AND PAPERS/NSF EDL1 Gesture and Math Talk/Results:Figures/SPSS/export_mathaction.tsv"
  /DELCASE=LINE
  /DELIMITERS="\t"
  /ARRANGEMENT=DELIMITED
  /FIRSTCASE=2
...
GET DATA  /TYPE=TXT
  /FILE="/Volumes/CRCDE$/CURRENT STUDIES AND PAPERS/NSF EDL1 Gesture and Math Talk/Results:Figures/SPSS/export_childgesture.tsv"
  /DELCASE=LINE
  /DELIMITERS="\t"
  /ARRANGEMENT=DELIMITED
  /FIRSTCASE=2
