...
output_file = '~/Desktop/export_childgesture.tsv' # change to .csv for comma separated value file
delimiter = "\t" # separator between data, "," for comma

# Enter names of relevant columns
id_col = "id"
par_gestmath_col = "gesture_mathwords"
child_col = "gestmath_childgesture" #Name of child column to export
...
child_col_order = ["onset","offset","childgest_ordinals","childgest_p","childgest_s","childgest_i","childgest_c"]
...
chi_col_header = %w[chi_ordinal chi_onset chi_offset childgest_ordinals childgest_p childgest_s childgest_i childgest_c]
