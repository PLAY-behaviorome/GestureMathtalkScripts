* Encoding: UTF-8.
***CHILD WORDS IMPORT_________.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/CRCDE$/CURRENT STUDIES AND PAPERS/NSF EDL1 Gesture and Math Talk/Results:Figures/SPSS/5secexports/export_childwords.tsv"
  /DELCASE=LINE
  /DELIMITERS="\t"
...
***CHILD MATHACTION IMPORT_________.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/CRCDE$/CURRENT STUDIES AND PAPERS/NSF EDL1 Gesture and Math Talk/Results:Figures/SPSS/5secexports/export_mathaction.tsv"
  /DELCASE=LINE
  /DELIMITERS="\t"
  /ARRANGEMENT=DELIMITED
  /FIRSTCASE=2
...
***CHILD GESTURE IMPORT_________.
GET DATA  /TYPE=TXT
  /FILE="/Volumes/CRCDE$/CURRENT STUDIES AND PAPERS/NSF EDL1 Gesture and Math Talk/Results:Figures/SPSS/5secexports/export_childgesture.tsv"
  /DELCASE=LINE
  /DELIMITERS="\t"
  /ARRANGEMENT=DELIMITED
  /FIRSTCASE=2
